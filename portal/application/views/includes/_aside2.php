                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <?php if ($this->session->role_id == 3):?>
                                ...
                                <li class="nav-item has-treeview">
                                    ...
                                    <ul class="nav nav-treeview">
                                       <li class="nav-item">
                                            <a href="<?= site_url('profile/Profiles'); ?>" class="nav-link">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>My Profile</p>
                                            </a>
                                        </li>
                                    ...
                                    <ul class="nav nav-treeview">
                                      ...
                                      <li class="nav-item">
                                          <a href="<?= site_url('ManageStudent/CLassStudent/');?>" class="nav-link">
                                              <i class="far fa-circle nav-icon"></i>
                                              <p>Drop Student</p>
                                          </a>
                                      </li>
                            ...
                            <?php if ($this->session->role_id == 1 || $this->session->role_id == 2):?>
                                <li class="nav-item has-treeview <?php echo $this->session->flashdata('menu') == 'dashboard' ? 'menu-open' : '';?>">
                                    <a href="#" class="nav-link <?php echo $this->session->flashdata('menu') == 'dashboard' ? 'active' : '';?>">
                                        <i class="nav-icon fas fa-th"></i>
                                        <p>Dashboard <i class="fas fa-angle-left right"></i> </p>
                                    </a>
                                    <ul class="nav nav-treeview">
                            ...
                            <?php if ($this->session->role_id == 4):?>
                                ...
                                <li class="nav-item has-treeview <?php echo $this->session->flashdata('menu') == 'activities' ? 'menu-open' : '';?>">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <li class="nav-item">
                                            <a href="<?= base_url('activities/playlists');?>" class="nav-link <?php echo $this->session->flashdata('submenu') == 'playlists' ? 'active' : '';?>">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>Playlists</p>
                                            </a>
                                        </li>

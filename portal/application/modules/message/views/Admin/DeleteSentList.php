                ...
                <div class="card card-primary card-outline">
                  ...
                  <div class="card-body p-0">
                    ...
                    <div class="table-responsive mailbox-messages p-2">
                      ...
                      <?php if($GetSentDelete->num_rows() > 0 ): ?>
                      <?php foreach($GetSentDelete->result() as $GetSentDelete_row): ?>
                        <tr>
                          <td>
                              <input type="checkbox" class="checkitem icheck-primary" value="<?= $GetSentDelete_row->message_id ?>" id="checkitem"/>
                          </td>
                          <td class="mailbox-star"><a href="#"><i class="fas fa-star-o text-warning"></i></a></td>
                          <td class="mailbox-name"><a href="<?= site_url('message/Messages/ReadMoreMessage/').$GetSentDelete_row->message_id ; ?>"><?=  $GetSentDelete_row->email ?></a></td>
                          <td class="mailbox-subject" style="display:block;text-overflow: ellipsis;width:600px;overflow: hidden; white-space: nowrap;">
                               <?=  $GetSentDelete_row->title ?>
                          </td>
                          <!-- <td class="mailbox-attachment"><i class="fas fa-paperclip"></i></td> -->
                          <td class="mailbox-date"><?= date('M d, Y : h:i  ', strtotime(  $GetSentDelete_row->created_at )); ?></td>
                        </tr>
                      <?php endforeach; ?>
                    <?php else: echo "Null";
                   endif; ?>
...
$(document).ready(function(){
 ...
 $.ajax({
   url:"<?= site_url('message/Messages/DeleteSentMessagelist'); ?>",
   method:"POST",

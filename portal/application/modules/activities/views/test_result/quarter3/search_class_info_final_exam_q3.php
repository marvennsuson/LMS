                        ...
                        <?php foreach($students as $stud):?>
                            ...
                            <td>
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" class="custom-control-input" id="switch_publish_final_exam3" <?php echo $stud['is_publish'] == '1' ? 'checked' : '';?>>
                                    <label class="custom-control-label" for="switch_publish_final_exam3" id="switch_publish_label_final_exam3"><?php echo $stud['is_publish'] == '1' ? 'Published' : 'Unpublished';?></label>
                                    </div>
                                </div>
                            </td>
                            <script>
                                var switchStatus_finalexam = false;
                                $("#switch_publish_final_exam3").on('change', function() {
                                    if ($(this).is(':checked')) {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(data){
                                                if(data.response == "false") {
                                                    ...
                                                    $("#switch_publish_label_final_exam3").html('Published');
                                                    Swal.fire({
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(data){
                                                if(data.response == "false") {
                                                    ...
                                                    $("#switch_publish_label_final_exam3").html('Unpublished');
                                                    Swal.fire({

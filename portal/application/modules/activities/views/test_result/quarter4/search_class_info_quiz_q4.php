                        ...
                        <?php foreach($students as $stud):?>
                            ...
                            <td>
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" class="custom-control-input" id="switch_publish_quiz4" <?php echo $stud['is_publish'] == '1' ? 'checked' : '';?>>
                                    <label class="custom-control-label" for="switch_publish_quiz4" id="switch_publish_label_quiz4"><?php echo $stud['is_publish'] == '1' ? 'Published' : 'Unpublished';?></label>
                                    </div>
                                </div>
                            </td>
                            <script>
                                var switchStatus_quiz = false;
                                $("#switch_publish_quiz4").on('change', function() {
                                    if ($(this).is(':checked')) {
                                        switchStatus_quiz = 1;
                                        $.ajax({
                                            ...
                                            success: function(data){
                                                if(data.response == "false") {
                                                    ...
                                                    $("#switch_publish_label_quiz4").html('Published');
                                                    Swal.fire({
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(data){
                                                if(data.response == "false") {
                                                    ...
                                                    $("#switch_publish_label_quiz4").html('Unpublished');
                                                    Swal.fire({

                        ...
                        <?php foreach($classes_by_class as $cl):?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php else:?>
                                        <a href="" id="btn_done<?php echo $cl['homework_id']?>"><button type="button" class="btn btn-info btn-sm" data-toggle="modal"><i style="font-size: 14px; color:white;" class="fa fa-eye"></i> Open</button></a>
                                    <?php endif;?>
                                </td>
                            </tr>
                            ...
                            <script>
                                $(document).ready(function(){
                                    $('#btn_done<?php echo $cl['homework_id']?>').on('click', function(){
                                        $('.overlay').css('visibility', 'visible');
                                        $.ajax({
                                            url: "<?=site_url('activities/open_homework')?>",
                                            data:{ homework_id : '<?=$cl['homework_id'];?>' },
                                            type: "post",

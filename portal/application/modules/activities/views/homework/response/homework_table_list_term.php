                        ...
                        <?php foreach($classes_by_term as $ct):?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php else:?>
                                        <a href="" id="btn_done<?php echo $ct['hw_reply_id']?>"><button type="button" class="btn btn-warning btn-sm" data-toggle="modal"><i class="fa fa-check"></i> Check</button></a>
                                    <?php endif;?>
                                </td>
                            </tr>
                            ...
                            <script>
                                $(document).ready(function(){
                                    $('#btn_done<?php echo $ct['hw_reply_id']?>').on('click', function(){
                                        $('.overlay').css('visibility', 'visible');
                                        $.ajax({
                                            url: "<?=site_url('activities/open_homework_teacher')?>",
                                            data:{ hw_reply_id : '<?=$ct['hw_reply_id'];?>' },
                                            type: "post",

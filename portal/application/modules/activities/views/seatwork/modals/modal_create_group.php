                                                                ...
                                                                <?php foreach($students_by as $sb):?>
                                                                    ...
                                                                    <script>
                                                                        $('#btn_delete<?php echo $sb['admission_id']?>').on('click', function(e){
                                                                            ...
                                                                            e.preventDefault();
                                                                            Swal.fire({
                                                                                title: 'Are you sure you want to delete seatwork by <br> <?= strtoupper($sb['firstname'])?> <?= strtoupper($sb['middlename'])?> <?= strtoupper($sb['lastname'])?> ?',
                                                                                ...
                                                                                if (result.value == true) {
                                                                                    $.ajax({
                                                                                        ...
                                                                                        success: function(data)
                                                                                        {
                                                                                            Swal.fire(
                                                                                                'Deleted!',
                                                                                                'Seatwork by <?= strtoupper($sb['firstname'])?> <?= strtoupper($sb['middlename'])?> <?= strtoupper($sb['lastname'])?> has been deleted.',
                                                                                                'info'
                                                                                            ).then((result) => {
                                                                                                location.reload();
                                                                                            })

                            ...
                            <?php
                                foreach ($searched_subject_code as $sbjc) {
                                    ...
                                    <tr>
                                        ...
                                        <td><button type = "button" class="btn btn-success btn-sm select btn-flat" id="btn-select" data-classid = "subject-<?php echo $sbjc['id']; ?>">Select</button></td>
                                    </tr>
                                    <?php
                                }
                            ?>
...
<script>
    $(document).on('click', "button.select", function () {
        ...
        if (subjectId) {
            ...
            $.ajax({
                url: "<?=site_url('directory_student/selected_subject_code')?>",
                data: {
                    id: subjectId
                },
                type: "post",

        ...
        <div class="container-fluid">
            ...
            <?php
                ...
                if (!empty($subject_details)) {
                        ...
                        <div class="card">
                            ...
                            <div class="card-body table-responsive p-0" id="div_selected_subject_table">
                                <table class="table table-striped table-hover table-head-fixed text-nowrap table-sm" id="search_subject_table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><?php echo $subject_details['subjectcode'];?></td>
                                                <td><?php echo $subject_details['subject_name'];?></td>
                                                <td><?php echo $subject_details['subject_description'];?></td>
                                                <td><?php echo $subject_details['section'];?></td>
                                                <td><?php echo $subject_details['schedule'];?></td>
                                                <td><?php echo $subject_details['teacher_code'];?></td>
                                                <td><?php echo $subject_details['classcode']; ?></td>
                                            </tr>
                                        </tbody>
                                </table>
                    ...
                    <input type="hidden" name="searchtype" id = "searchtype" value = "subject,<?php echo $subject_details['subjectcode']?>">
                    <input type="hidden" name = "edit_input_subject_id" id ="edit_input_subject_id" value = "<?php echo $subject_details['subjectcode']?>">
                    <?php
                }else{
                    ?>
                    <div class="box-body">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($student_registered as $sr) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><button type="button" class="btn btn-danger btn-sm delete_registered_student"  data-classid="rstudent-<?php echo $sr['id'];?>" data-toggle="modal" data-target="#register_student_delete"><i class="fa fa-trash"></i></button</td>
                                                </tr>
                                                <?php
                                            }
                                            ?>
          ...
          <div class="justify-content-end d-flex pull-right ">
              <button type="button" id="btn_update_register" class="btn btn-primary btn-sm btn-flat">Save</button>
          </div>
        </div>
    </form>
</div>
...
<script>
    ...
    $('#btn_update_register').click(function(){
        Swal.fire({
            title: 'Are you sure you want to save <br>?',

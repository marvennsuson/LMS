                                ...
                                <table class="table table-striped table-hover table-head-fixed text-nowrap table-sm" id="search_subject_table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo $subject_details['subjectname'];?></td>
                                                <td><?php echo $subject_details['subjectdesc'];?></td>
                                                <td><?php echo $subject_details['section'];?></td>
                                                <td><?php echo $subject_details['schedule'];?></td>
                                                <td><?php echo $subject_details['teacherid'];?></td>
                                                <td><?php echo $subject_details['blockclassid']; ?></td>
                                            </tr>
                                        </tbody>
                                </table>
